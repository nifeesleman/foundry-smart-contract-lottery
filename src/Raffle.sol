...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    error Raffle__upkeepNeeded(uint256 balance, uint256 playersLength, uint256 state);
     ...
     * if the lottary is ready to have a winner picked.
     * The following should be true in order to unkeepneeded to be true.
     * 1. The time interval has passed between raffle runs
     * 2. The lottary is open
     * 3. The contract has ETH
     * 4. Implicitly, your subscription has link
     * @param -ignored
     * @return upkeepNeeded -true if it's time to restart the lottary
     * @return -ignored
     */
